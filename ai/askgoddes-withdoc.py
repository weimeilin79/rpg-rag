...
loader = DirectoryLoader('./story', glob="./Elara.md", show_progress=True)
...
chat_template = ChatPromptTemplate.from_messages(
    [
        SystemMessagePromptTemplate.from_template("You are a goddess of wisdom and knowledge Elara in the following pieces of context, has been asked a question. You must provide an answer."
                "Your personality is a lay back, calm, with a hint of sexiness in your voice.. Don't answer if the question is not in the context."
